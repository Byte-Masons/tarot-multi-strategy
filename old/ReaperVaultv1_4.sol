...
contract ReaperVaultv1_4 is ERC20, Ownable, ReentrancyGuard {
    ...
    /**
     * Helper version for FE-ABI consistency that always defaults to
     * using flash loans for withdrawals.
     */
    function withdrawAll() external {
        withdrawWithMode(balanceOf(msg.sender), true);
    }

    /**
     * @dev A helper function to call withdraw() with all the sender's funds.
     */
    function withdrawAllWithMode(bool _useFL) external {
        withdrawWithMode(balanceOf(msg.sender), _useFL);
    }
     ...
     */
    function withdrawWithMode(uint256 _shares, bool _useFL) public nonReentrant {
